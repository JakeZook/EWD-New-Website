		...
		<>
			<div
				className={`flex flex-col justify-center items-center my-10 ${
					props.index === 0 || props.index % 2 === 0 ? "mr-48" : "ml-48"
				}`}
			>
				<img
					onClick={() => {
					...
					className="w-72 h-full mask mask-decagon object-cover hover:scale-110 transition-transform duration-300 ease-in-out cursor-pointer"
					src={props.data.img}
					alt={props.data.name}
				/>
				<div className="flex justify-around mt-5">
					<button
						className="btn btn-primary hover:btn-accent mr-5 text-xl"
						onClick={() => {
